...
const std::string MODEL_PATH = "assets/models/viking_room_by_nigelgoh/viking_room.obj";
const std::string TEXTURE_PATH = "assets/models/viking_room_by_nigelgoh/viking_room.png";
...
private:
    ...
    void createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& _buffer, VkDeviceMemory& _bufferMemory);
    ...
    void createImage(uint32_t width, uint32_t height, uint32_t _mipLevels, VkSampleCountFlagBits numSamples,
    ...
    void transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout,
        VkImageLayout newLayout, uint32_t _mipLevels);
    void copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height);
    void createTextureImageView();
    VkImageView createImageView(VkImage image, VkFormat format,
        VkImageAspectFlags aspectFlags, uint32_t _mipLevels);
...
public:
    void run();
    void setBufferResizedBool(bool n);
...
void VulkanApplication::createGraphicsPipeline() {
    ...
    if (vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS) {
        throw std::runtime_error("gailed to create graphics pipeline");
    }
...
void VulkanApplication::recordCommandBuffer(VkCommandBuffer _commandBuffer, uint32_t imageIndex) {
    ...
    vkCmdBindDescriptorSets(_commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, pipelineLayout,
...
void VulkanApplication::drawFrame() {
    ...
    if (result == VK_ERROR_OUT_OF_DATE_KHR) {
        ...
        throw std::runtime_error("failed to grab new swapchain image");
    }
...
static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
    ...
    app->setBufferResizedBool(true);
}

void VulkanApplication::setBufferResizedBool(bool n) {
    framebufferResized = n;
}
...
void VulkanApplication::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& _buffer, VkDeviceMemory& _bufferMemory) {
...
void VulkanApplication::updateUniformBuffer(uint32_t currentImage) {
    ...
    ubo.model = glm::rotate(glm::mat4(1.0f), glm::radians(25.0f),
...
void VulkanApplication::createImage(uint32_t width, uint32_t height, uint32_t _mipLevels, VkSampleCountFlagBits numSamples,
    VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties,
    VkImage& image, VkDeviceMemory& imageMemory) {
...
void VulkanApplication::endSingleTimeCommands(VkCommandBuffer _commandBuffer) {
...
void VulkanApplication::transitionImageLayout(VkImage image, VkFormat format,
    VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t _mipLevels) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void VulkanApplication::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight,
    uint32_t _mipLevels) {
